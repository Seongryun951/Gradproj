...
echo "=========================================="
echo "  GPU 0, 1, 2, 3에서 병렬 실행 (OPT-6.7B, CoQA)"
...
echo "  작업 정보"
echo "=========================================="
echo "GPU 0 PID: $PID0 (데이터 0~1994, 약 1,995개)"
echo "GPU 1 PID: $PID1 (데이터 1995~3989, 약 1,995개)"
echo "GPU 2 PID: $PID2 (데이터 3990~5984, 약 1,995개)"
echo "GPU 3 PID: $PID3 (데이터 5985~7982, 약 1,998개)"
echo ""
echo "진행 상황 확인:"
...
echo "=========================================="
echo "결과 저장 위치:"
echo "  - output/opt-6.7b_coqa_softmaxlayer_0/0.pkl (약 1,995개)"
echo "  - output/opt-6.7b_coqa_softmaxlayer_1/0.pkl (약 1,995개)"
echo "  - output/opt-6.7b_coqa_softmaxlayer_2/0.pkl (약 1,995개)"
echo "  - output/opt-6.7b_coqa_softmaxlayer_3/0.pkl (약 1,998개)"
echo ""
echo "총 약 7,983개 데이터 처리 완료"
echo ""
echo "다음 단계:"
echo "  1. python merge_gpu0_1_2_3.py  # 결과 병합"
