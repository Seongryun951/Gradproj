...
echo "=========================================="
echo "  2개의 GPU에서 병렬 실행 (GPU 0, 2)"
echo "=========================================="
echo ""

# GPU 0 - 데이터의 1/2 (첫 번째 절반)
echo "[GPU 0] 첫 번째 1/2 데이터 처리 시작..."
...
echo "  작업 정보"
echo "=========================================="
echo "GPU 0 PID: $PID0 (데이터 0~3990)"
echo "GPU 2 PID: $PID2 (데이터 3991~7982)"
echo ""
echo "진행 상황 확인:"
echo "  - watch nvidia-smi"
echo "  - tail -f data/output/logInfo_opt-6.7b_coqa.txt"
echo ""
echo "작업 취소: kill $PID0 $PID2"
echo "=========================================="
echo ""
...
echo "=========================================="
echo "결과 저장 위치:"
echo "  - output/opt-6.7b_coqa_0/0.pkl (약 3,991개)"
echo "  - output/opt-6.7b_coqa_2/0.pkl (약 3,992개)"
echo ""
